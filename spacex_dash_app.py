...
site_dict = {'site1':launch_sites[0],
             'site2':launch_sites[1],
             'site3':launch_sites[2],
             'site4':launch_sites[3]}
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', 
                                             options=[{'label': 'All Sites', 'value': 'ALL'},
                                                      {'label': launch_sites[0], 'value': 'site1'},
                                                      {'label': launch_sites[1], 'value': 'site2'},
                                                      {'label': launch_sites[2], 'value': 'site3'},
                                                      {'label': launch_sites[3], 'value': 'site4'}],
                                              value = 'ALL',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(data,
        names = 'class',
        title=f'Total Successful Launches for site {site_dict[entered_site]}')
